  ...
  return (
    <>
      ...
      <Intro
        ...
        imgUrl={introBg}
        titleTranslation="Hakkımızda"
      />
      <section className="abMain">
        <article>
          <h2 className={cormorant.className}>Who are the Codeneers?</h2>
          <p>
        ...
        <article>
          <h2 className={cormorant.className}>Why this project?</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
            ...
            dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            incididunt ut labore et dolore magna aliqua. Ut enim ad minim
            veniam, quis nostrud e
          </p>
        </article>
        <article>
          <h2 className={cormorant.className}>Vision</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
